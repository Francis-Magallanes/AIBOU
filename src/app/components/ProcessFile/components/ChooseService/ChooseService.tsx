"use client";
import { ChangeEvent, FC, useState, Dispatch, SetStateAction, useEffect } from "react";
import {
	VStack,
	Text,
	Heading,
...
const ChooseService: FC<ChooseServiceProps> = ({
	...
	return (
		<>
			<VStack w={width} h={height} alignItems="normal">
				<Text paddingBottom="0.5rem">
					File to be Processed: <i>{fileName}</i>
				</Text>
				<VStack gap="2rem">
					<Heading size="md" textAlign="center">
						Choose <b>One</b> of the Services Offered and its configuration for the processing of
						file.
					</Heading>
					...
					{serviceConfig.typeOfService === "CREATEQUESTIONAIRE" && (
						<VStack gap="1rem">
							...
							>
								...
								<Radio size="md" padding="0rem 1rem" value="SINGLE">
									Single Answer
								</Radio>
								<Radio size="md" padding="0rem 1rem" value="MULTIPLE">
									Multiple Answers
								</Radio>
								<Radio size="md" padding="0rem 1rem" value="BOOLEAN">
									True or False
								</Radio>
								<Radio size="md" padding="0rem 1rem" value="ESSAY">
									Essay
								</Radio>
							</RadioGroup>
					...
					{serviceConfig.typeOfService === "SUMMARIZE" && (
						<VStack>
							...
							>
								...
								<Radio size="md" padding="0rem 1rem" value="PARAGRAPH">
									Paragraph
								</Radio>
								<Radio size="md" padding="0rem 1rem" value="BULLET">
									Bullet
								</Radio>
							</RadioGroup>
